import 'package:futurewrold/model/teacher/chat/addNumber/ReturnObject.dart';

class ReturnAddGroupNumber {
  String what;
  bool returnKey;
  ReturnObject returnObject;
  String why;

  ReturnAddGroupNumber(
      {this.what, this.returnKey, this.returnObject, this.why});

  ReturnAddGroupNumber.fromJson(Map<String, dynamic> json) {
    what = json['what'];
