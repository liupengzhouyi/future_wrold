import 'package:futurewrold/model/student/rePassword/ReturnObject.dart';

class ReturnStudentRePasswordEntity {
  String what;
  bool returnKey;
  ReturnObject returnObject;
  String why;

  ReturnStudentRePasswordEntity(
      {this.what, this.returnKey, this.returnObject, this.why});

  ReturnStudentRePasswordEntity.fromJson(Map<String, dynamic> json) {
    what = json['what'];
